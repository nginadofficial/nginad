...
namespace buyrtbfidelity\parsers\openrtb\parselets\common\banner;
use \Exception;

class ParseAboveTheFold {
	
	public static function execute(&$Logger, \buyrtbfidelity\parsers\openrtb\OpenRTBParser &$Parser, \model\openrtb\RtbBidRequestBanner &$RtbBidRequestBanner, &$ad_impression_banner) {
		...
		*/
		...
		if (isset($ad_impression_banner["pos"])):
			...
			/*
			 * Imp Banner Position is required by OpenRTB, yet Fidelity doesn't have it.
