...
class PrivateExchangeRtbChannelDailyStatsRollUpPxFilter extends \_factory\CachedTableRead
{
    ...
    public static function get_instance() {
            ...
            if (self::$instance == null):
                    self::$instance = new \_factory\PrivateExchangeRtbChannelDailyStatsRollUpPxFilter();
            endif;
    ...
    function __construct() {
            ...
            $this->table = 'PrivateExchangeRtbChannelDailyStatsRollUpPxFilter';
