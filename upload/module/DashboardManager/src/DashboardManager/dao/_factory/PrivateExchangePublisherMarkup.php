...
class PrivateExchangePublisherMarkup extends \_factory\CachedTableRead
{
	...
	public static function get_instance() {
		...
		if (self::$instance == null):
			self::$instance = new \_factory\PrivateExchangePublisherMarkup();
		endif;
    ...
    function __construct() {
            ...
            $this->table = 'PrivateExchangePublisherMarkup';
