...
class Markup {
	...
	public static function getMarkupRate($AdCampaign, $config) {
		...
		$ad_campaign_markup = self::getMarkupForAdCampaign($AdCampaign->AdCampaignID);
		...
		$user_markup = self::getMarkupForUser($AdCampaign->UserID);
	...
	public static function getMarkupForAdCampaign($ad_campaign_id) {
	...
	public static function getMarkupForPublisherWebsite($publisher_website_id) {
	...
	public static function getMarkupForUser($user_id) {
	...
	public static function getMarkupForPublisher($publisher_info_id) {
	...
	public static function getPublisherMarkupRate($publisher_website_id, $publisher_info_id, $config) {
		...
		$publisher_website_markup = self::getMarkupForPublisherWebsite($publisher_website_id);
		...
		$publisher_markup = self::getMarkupForPublisher($publisher_info_id);
